...
`--anoco-temperature 0.07`. `--anoco-view-balance` first keeps the best
query-anchor candidate from each augmented normal view, preventing one
rotation from filling the complete neighborhood. The implementation reuses the normal memory,
