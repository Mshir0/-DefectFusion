...
class ReportingTest(unittest.TestCase):
    ...
    def test_summary_csv_contains_categories_and_macro_average(self):
        metrics = [{
            ...
            "defect_images": 6, "defect_decision_images": 6,
            "defect_predicted_anomaly": 5, "defect_predicted_normal": 1,
            "defect_recall": 5 / 6, "balanced_accuracy": 19 / 24,
            "decision_accuracy": 0.8, "pixel_metric_images": 6,
        ...
        self.assertEqual(rows[0]["defect_predicted_anomaly"], "5")
        self.assertEqual(rows[0]["defect_predicted_normal"], "1")
        self.assertEqual(rows[0]["defect_recall"], str(5 / 6))
        self.assertEqual(rows[0]["balanced_accuracy"], str(19 / 24))
        self.assertEqual(rows[0]["decision_accuracy"], "0.8")
