...
def main(argv=None):
    ...
    f.add_argument("--top-k-ratio", type=float, default=0.1, help="highest PCA-residual patch ratio for typing")
    ...
    e.add_argument("--top-k-ratio", type=float, default=0.1, help="highest PCA-residual patch ratio for typing")
    ...
    if a.cmd == "fit":
        ...
        fusion = DefectFusion(extractor, alpha=alpha, unknown_threshold=threshold, top_k_ratio=a.top_k_ratio).fit_normal(paths)
        ...
        for category in categories:
            ...
            fusion = DefectFusion(extractor, top_k_ratio=a.top_k_ratio).fit_normal(_images(normal_dir))
            if a.prototype_dir:
            ...
            metrics["top_k_ratio"] = a.top_k_ratio
