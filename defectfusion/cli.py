...
def main(argv=None):
    ...
    f.add_argument("--type-matching", choices=["prototype_mean", "bidirectional_patch", "shrinkage_lda"], default=None)
    ...
    e.add_argument("--type-matching", choices=["prototype_mean", "bidirectional_patch", "shrinkage_lda"], default=None)
