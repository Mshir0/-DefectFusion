...
- [x] Add training-free DINO-guided spatial filtering before cross-layer evidence reduction.
- [ ] Add retrieval entropy or neighbor-margin confidence as a rejection signal.
