...
- [x] Evaluate robust Top-K retrieval cost aggregation (removed after negative Seed 42 ablation).
- [x] Evaluate DINO-guided spatial evidence filtering (removed after neutral Seed 42 ablation).
- [x] Add calibrated Top-K retrieval entropy as a normal-candidate rejection signal.
- [ ] Add semantic-prototype-to-instance hierarchical retrieval.
- [ ] Select normal augmentation views with CLS-token similarity.
