...
- [x] Remove robust Top-K cost, guided filtering, retrieval entropy, and semantic retrieval after neutral or negative ablations.
- [x] Add global-feature selection of normal augmentation views for per-layer ANoCo.
