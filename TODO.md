...
- [x] Evaluate bidirectional defect-type patch matching (removed with the classification branch).
...
- [ ] Re-evaluate INSID3 positional debiasing for normal-reference anomaly matching.
- [ ] Add PCA score ablations: cosine residual, dropped PCs, and Mahalanobis residual.
- [ ] Score each normal reference independently and robustly aggregate reference scores.
- [ ] Calibrate uncertainty from agreement across multiple normal references.
- [x] Remove labeled-defect classification and keep the project anomaly-detection only.
